...
export function IndicadorAlertas() {
  ...
  return (
    <div 
      className="fixed top-4 right-4 z-[60] flex items-center gap-2 px-3 py-1.5 rounded-lg backdrop-blur-md transition-all duration-300 hover:scale-105 shadow-lg"
      style={{
        background: isActive 
